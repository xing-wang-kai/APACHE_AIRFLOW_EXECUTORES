...
def get_history(ticker, ds=None, ds_nodash=None):
    ...
    file_path = f'/home/kaiwang/Documents/airflow_celeby/datalake/BRONZE/STONKS/{ticker}/{ticker}_{ds_nodash}.csv'
...
def get_stoncks():
    ...
    for ticker in TICKERS:
        get_history.override(
            task_id=f"BRONZE_STONCKS_{ticker}",
            pool='default_pool'
        )(ticker)
